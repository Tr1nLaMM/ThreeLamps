                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-custom">
                                <li><a href="/category/1" class="dropdown-item">Đời sống-xã hội</a></li>
                                <li><a href="/category/2" class="dropdown-item">Trinh thám-kinh dị</a></li>
                                <li><a href="/category/3" class="dropdown-item">Ngôn tình</a></li>
                                <li><a href="/category/4" class="dropdown-item">Tiểu thuyết</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
